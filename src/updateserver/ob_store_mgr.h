...
namespace oceanbase
{
  namespace updateserver
  {
    class StoreMgr
    {
      ...
      private:
        static constexpr int64_t DEVICE_SET_SIZE = 10;
        static constexpr double DEFAULT_DISK_RESERVED_RATIO = 0.1;
        static constexpr int64_t DEFAULT_DISK_RESERVED_SPACE = 10L * 1024L * 1024L * 1024L;
        static constexpr int64_t DEFAULT_DISK_ENFILE_INTERVAL_TIME = 10 * 60 * 1000 * 1000;
        struct StoreNode;
        struct RaidNode;
